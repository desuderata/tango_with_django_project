...
def index(request):
    ...
    # # cookie monster: the rising of the cookie monster
    ...
    # cookie monster 2: the return of the cookie monster
...
def about(request):
    ...
    # cookie monster 3: the sequel of the return of the cookie monster
    visitor_cookie_handler(request)
